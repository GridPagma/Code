...
class DeviceScreenB extends StatefulWidget {
  final BluetoothDevice device;

  const DeviceScreenB({Key? key, required this.device}) : super(key: key);

  @override
  State<DeviceScreenB> createState() => _DeviceScreenBState();
}

class _DeviceScreenBState extends State<DeviceScreenB> {
  int? _rssi;
  int? _mtuSize;
